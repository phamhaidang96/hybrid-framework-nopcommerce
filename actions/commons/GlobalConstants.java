...
public class GlobalConstants {
	...
	public static final String BROWSER_LOG_FOLDER = PROJECT_PATH + File.separator + "browserLogs" + File.separator;
	...
	public static final String EXTENT_PATH = PROJECT_PATH + File.separator + "extentReportV2";

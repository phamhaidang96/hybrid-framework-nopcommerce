...
//
// Assert.assertEquals(basePage.getElementText(driver,
// "//div[contains(@class,'message-error')]//li"), "The specified email already
// exists");
// }
//
// @Test
...
//
// Assert.assertEquals(basePage.getElementText(driver,
// "//span[@id='Password-error']"), "Password must meet the following
...
//
// Assert.assertEquals(basePage.getElementText(driver,
// "//span[@id='ConfirmPassword-error']"), "The password and confirmation
